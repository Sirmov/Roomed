...
namespace Roomed.Domain.Reservations.Entities
{
    ...
    using static Roomed.Domain.Reservations.Constants.ReservationConstraints;

    /// <summary>
    /// Reservation entity model. Inherits <see cref="BaseDeletableModel{TKey}"/>. Has <see cref="Guid"/> id.
    /// </summary>
