// |-----------------------------------------------------------------------------------------------------|
// <copyright file="AfterDateAttribute.cs" company="Roomed">
...
namespace Roomed.Common.ValidationAttributes
{
    ...
    /// <summary>
    /// This validation attribute validates that the date of this property is after another one.
    /// </summary>
    [AttributeUsage(AttributeTargets.Property | AttributeTargets.Field, AllowMultiple = true)]
    public class AfterDateAttribute : ValidationAttribute
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AfterDateAttribute"/> class.
        /// </summary>
        ...
        public AfterDateAttribute(Type dateType, string otherProperty)
        {
        ...
        /// Checks if both are of the correct type and validates that the date of this property is after the other one.
        /// </summary>
